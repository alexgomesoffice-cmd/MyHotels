  ...
  return (
    <section className="bg-blue-800 text-white py-20 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        {/* Search Box */}
        <div className="bg-white rounded-lg p-4 shadow-lg flex flex-col md:flex-row gap-3 items-center">
          ...
          <div className="flex items-center gap-2 border border-gray-300 rounded-lg px-4 py-3 flex-1">
            ...
            <input type="text" placeholder="Where are you going?" className="w-full focus:outline-none text-black" />
          </div>

          {/* Dates */}
          <div className="flex items-center gap-2 border border-gray-300 rounded-lg px-4 py-3 flex-1">
            <CalendarDaysIcon className="w-6 h-6 text-gray-500" />
            <input type="text" placeholder="Check-in — Check-out" className="w-full focus:outline-none text-black" />
          </div>

          {/* Guests */}
          <div className="flex items-center gap-2 border border-gray-300 rounded-lg px-4 py-3 flex-1">
            <UserIcon className="w-6 h-6 text-gray-500" />
            <input type="text" placeholder="2 adults · 0 children · 1 room" className="w-full focus:outline-none text-black" />
          </div>
